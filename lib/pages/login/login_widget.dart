                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    20.0, 20.0, 20.0, 20.0),
                                            child: Text(
                                              'Ao clicar em criar conta, verifique seu e-mail para\n ativar e aproveitar todos os benefícios.',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      ...
                                                      ScaffoldMessenger.of(
                                                        ...
                                                        SnackBar(
                                                          content: Text(
                                                            'Acesse sua caixa de E-mail e ative sua conta.',
                                                            style: TextStyle(
                                                              color: FlutterFlowTheme
                                                                      .of(context)
                                                                  .primaryText,
